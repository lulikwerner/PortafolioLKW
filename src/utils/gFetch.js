let projects = [
  { id: 1, title: "FULLSTACK", img:"../assets/img/fullstack.png", description:"Javascript - Mongoose - Postman - NPM - Token - Cookies - CSS - HTML - Sweet Alert", link:"https://backend-commerce-dev.onrender.com/"},
    ...
    { id: 7, title: "CODER STORE", img:"../assets/img/coderstore.png", description:"Python - Virtualenv - Node- CSS - HTML", link:"https://github.com/lulikwerner/CoderStore.git"}
